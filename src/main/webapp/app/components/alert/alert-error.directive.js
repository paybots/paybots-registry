(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('PaybotsRegistryApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-PaybotsRegistryApp-error');
                var entityKey = httpResponse.headers('X-PaybotsRegistryApp-params');
                if (errorHeader) {
