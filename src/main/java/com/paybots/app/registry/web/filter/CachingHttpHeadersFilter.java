...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(PaybotsProperties paybotsProperties) {
        this.paybotsProperties = paybotsProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        CACHE_TIME_TO_LIVE = TimeUnit.DAYS.toMillis(paybotsProperties.getHttp().getCache().getTimeToLiveInDays());
    }
